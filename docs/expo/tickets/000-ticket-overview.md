...
|----|---------|------------|------|------|
| 001 | Firebase接続設定 | - | **完了** | 2025-12-10完了 |
| 002 | Expo開発環境セットアップ | 001 | **完了** | |
| 003 | Zustand状態管理基盤 | 002 | **完了** | |
| 004 | Expo Router設定 | 002 | **完了** | |
| 005 | React Native Paper UI基盤 | 002 | **完了** | 2025-12-10完了 |
| 006 | 認証画面（ログイン・登録） | 003, 004, 005 | **完了** | |
| 007 | 利用規約同意画面 | 004, 005 | **完了** | |
| 008 | ホーム画面 | 005, 010 | **完了** | 2025-12-10完了 |
| 009 | プロフィール画面 | 005, 010 | **完了** | 2025-12-10完了 |
| 010 | ボトムナビゲーション | 004, 005 | **完了** | 2025-12-10完了 |

### Phase 2: MediaPipe統合・画面実装（011-030）

| ID | タイトル | 依存チケット | 状態 | 備考 |
|----|---------|------------|------|------|
| 011 | MediaPipe PoC（技術検証） | 002 | **完了** | 2025-12-11実装完了、実機テスト待ち |
| 012 | カメラ機能実装 | 011 | **進行中** | 実装完了、実機テスト待ち |
| 013 | 骨格検出基盤 | 011, 012 | **進行中** | 実装完了、実機テスト待ち |
| 014 | フォーム評価エンジン | 013 | **完了** | 2025-12-11完了 |
| 015 | スクワット評価ロジック | 014 | **進行中** | コード実装完了、実機テスト待ち |
| 016 | プッシュアップ評価ロジック | 014 | **進行中** | コード実装完了、実機テスト待ち |
| 017 | アームカール評価ロジック | 014 | **進行中** | コード実装完了、実機テスト待ち |
| 018 | サイドレイズ評価ロジック | 014 | **進行中** | コード実装完了、実機テスト待ち |
| 019 | ショルダープレス評価ロジック | 014 | **進行中** | コード実装完了、実機テスト待ち |
| 020 | メニュー選択画面 | 010 | **完了** | 2025-12-11実装完了 |
| 021 | トレーニング実行画面 | 012, 013, 020 | **完了** | 2025-12-11実装完了、実機テスト待ち |
| 022 | セッション結果画面 | 021 | **完了** | 2025-12-11実装完了 |
| 023 | 音声フィードバック機能 | 021 | **完了** | 2025-12-11実装完了、expo-speech |
| 024 | 履歴画面実装 | 010 | **完了** | 2025-12-11実装完了、TanStack Query |
| 025 | カレンダー表示機能 | 024 | **完了** | 2025-12-11実装完了、react-native-calendars |
| 026 | グラフ表示機能 | 024 | **完了** | 2025-12-11実装完了、react-native-chart-kit |
| 027 | 設定画面実装 | 010 | **完了** | 2025-12-11実装完了 |
| 028 | 通知設定機能 | 027 | **完了** | 2025-12-11実装完了、expo-notifications |
| 029 | ヘルプセンター | 027 | **完了** | 2025-12-11実装完了、FAQ・お問い合わせ |
...
| expo/006 認証画面 | common/002 Firestore Security Rules | ✅ 完了 | Security Rules完了後に認証画面のテストが可能 |
...
| expo/007 利用規約同意画面 | common/006 GDPR同意管理API | ✅ 完了 | 同意管理API完了後に利用規約画面が実装可能 |
| expo/009 プロフィール画面 | common/007 ユーザーAPI | ✅ 完了 | ユーザーAPI完了後にプロフィール画面が実装可能 |
...
graph TD
    ...
    style 012 fill:#FFD700
    style 013 fill:#FFD700
...
```
Phase 1: ########## 100% (10/10完了) ✅ 完了！
Phase 2: ############  60% (12/20完了) + 2件進行中
Phase 3: ----------   0% (0/10完了)
Phase 4: ----------   0% (0/10完了)
全体:    ########--  44% (22/50完了)
```
...
| ID | タイトル | 完了日 |
|----|---------|--------|
| 001 | Firebase接続設定 | 2025-12-10 |
| 002 | Expo開発環境セットアップ | 2025-12-09 |
| 003 | Zustand状態管理基盤 | 2025-12-09 |
| 004 | Expo Router設定 | 2025-12-09 |
| 005 | React Native Paper UI基盤 | 2025-12-10 |
| 006 | 認証画面（ログイン・登録） | 2025-12-09 |
| 007 | 利用規約同意画面 | 2025-12-09 |
| 008 | ホーム画面 | 2025-12-10 |
| 009 | プロフィール画面 | 2025-12-10 |
| 010 | ボトムナビゲーション | 2025-12-10 |
| 011 | MediaPipe PoC（技術検証） | 2025-12-11 |
| 014 | フォーム評価エンジン | 2025-12-11 |
| 020 | メニュー選択画面 | 2025-12-11 |
| 021 | トレーニング実行画面 | 2025-12-11 |
| 022 | セッション結果画面 | 2025-12-11 |
| 023 | 音声フィードバック機能 | 2025-12-11 |
| 024 | 履歴画面実装 | 2025-12-11 |
| 025 | カレンダー表示機能 | 2025-12-11 |
| 026 | グラフ表示機能 | 2025-12-11 |
| 027 | 設定画面実装 | 2025-12-11 |
| 028 | 通知設定機能 | 2025-12-11 |
| 029 | ヘルプセンター | 2025-12-11 |
| - | expo_app作成 | 2025-12-09 |

### 次のマイルストーン

| マイルストーン | 目標日 | 完了条件 | 関連チケット | 状態 |
|-------------|--------|---------|-----------|------|
| **M1: Phase 1完了** | 2ヶ月後 | 全10件完了 | 001-010 | ✅ **完了** |
| **M2: MediaPipe PoC完了** | 3ヶ月後 | 姿勢検出動作確認 | 011-013 | 🔄 **進行中**（実機テスト待ち） |
| **M3: 5種目実装完了** | 5ヶ月後 | 全評価ロジック実装 | 014-019 | 🔄 **進行中**（014完了、015-019実装完了・実機テスト待ち） |
| **M4: MVP完成** | 7ヶ月後 | ストア申請準備完了 | 001-030 | ⏳ 未着手 |
| **M5: 課金機能リリース** | 9ヶ月後 | Stripe課金稼働 | 031-038 | ⏳ 未着手 |
...
| 3.1.0 | 2025年12月11日 | Phase 2進捗更新。011完了、012-013進行中（実機テスト待ち）、014完了 |
| 3.2.0 | 2025年12月11日 | 5種目評価ロジック（015-019）コード実装完了、実機テスト待ち |
| 3.3.0 | 2025年12月11日 | チケット011の備考を更新（「実機テスト待ち」を明記） |
| 3.4.0 | 2025年12月11日 | チケット020-024実装完了（メニュー、トレーニング、結果、音声、履歴） |
| 3.5.0 | 2025年12月11日 | チケット025-029実装完了（カレンダー、グラフ、設定、通知設定、ヘルプ） |
