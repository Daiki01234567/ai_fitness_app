...
### Firebase プロジェクト作成
- [x] Firebase コンソールでプロジェクト作成（tokyo-list-478804-e5）
...
### 環境分離
- [x] 開発環境プロジェクト作成（tokyo-list-478804-e5を共用）
- [x] ステージング環境プロジェクト作成（tokyo-list-478804-e5を共用）
- [x] 本番環境プロジェクト作成（tokyo-list-478804-e5を共用）
...
## 注意事項
- プロジェクトIDは `tokyo-list-478804-e5` を使用
