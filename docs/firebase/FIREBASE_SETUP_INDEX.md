...
### 0. BigQuery データパイプライン (NEW)

Firestore → Pub/Sub → BigQuery のデータパイプライン構築に関するドキュメントです。

| ファイル | 対象 | 説明 |
|---------|------|------|
| **BIGQUERY_SETUP_STATUS.md** | 全開発者 | BigQueryセットアップ完了レポートと次のステップ |
...
| バージョン | 日付 | 変更内容 |
|---------|------|--------|
| v1.1 | 2025-12-04 | BigQuery セットアップドキュメント追加 |
