...
- [x] システム全体の健全性をチェックするAPIを実装
- [x] Cloud Functionsの稼働状態を取得
- [x] Firestoreの接続状態を確認
- [x] BigQueryの接続状態を確認
- [x] 各サービスのレスポンス時間を計測
...
- [x] 過去1時間のエラー発生数を取得するAPIを実装
- [x] エラーの種類別集計を実装
- [x] エラー発生トレンドを取得
- [x] 重大度（severity）別のエラー集計を実装

### リクエスト監視API

- [x] リアルタイムのリクエスト数を取得するAPIを実装
- [x] エンドポイント別のリクエスト数を取得
- [x] レスポンス時間の統計を取得（平均、中央値、95パーセンタイル）
- [x] エラー率を計算

### パフォーマンス監視API

- [x] Cloud Functionsのメモリ使用量を取得するAPIを実装
- [x] Cloud Functionsの実行時間を取得
- [x] コールドスタート発生率を取得
- [x] Firestore読み取り/書き込み回数を取得

### テスト

- [x] システムヘルスチェックのユニットテストを作成
- [x] エラー監視のユニットテストを作成
- [x] リクエスト監視のユニットテストを作成
- [x] パフォーマンス監視のユニットテストを作成
- [x] 権限チェックのテストを作成
