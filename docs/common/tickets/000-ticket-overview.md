...
## 5. Expo版・Flutter版への影響

Common（共通バックエンド）のチケットが完了すると、以下のExpo版・Flutter版チケットに着手できるようになります。

### Phase 1完了による影響

| Common チケット | 完了時期 | Expoチケットへの影響 | Flutterチケットへの影響 |
|--------------|---------|-----------------|------------------|
| 001-003 | 0-1ヶ月 | 認証画面実装（010-012） | 認証画面実装（010-012） |
| 004 | 1-2ヶ月 | ホーム画面（013-014） | ホーム画面（013-014） |
| 007-008 | 1-2ヶ月 | 監視基盤共有 | 監視基盤共有 |

### Phase 2完了による影響

| Common チケット | 完了時期 | Expoチケットへの影響 | Flutterチケットへの影響 |
|--------------|---------|-----------------|------------------|
| 011-014 | 2-4ヶ月 | トレーニング記録機能（036） | トレーニング記録機能（036） |
| 015-017 | 3-5ヶ月 | BigQuery同期（044） | BigQuery同期（044） |
| 018-021 | 3-5ヶ月 | GDPR機能（046） | GDPR機能（046） |
| 022-023 | 4-6ヶ月 | プッシュ通知（043） | プッシュ通知（043） |

### Phase 3完了による影響

| Common チケット | 完了時期 | Expoチケットへの影響 | Flutterチケットへの影響 |
|--------------|---------|-----------------|------------------|
| 031-040 | 8-9ヶ月 | 課金機能（052-059） | 課金機能（052-059） |
