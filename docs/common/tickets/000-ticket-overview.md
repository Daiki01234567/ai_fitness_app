...
|----|---------|------------|------|-----------|
| 001 | Firebase環境確認 | - | 完了 | NFR-005, NFR-009 |
| 002 | Firestore Security Rules実装 | 001 | 進行中 | NFR-012, NFR-034 |
| 003 | Cloud Functions基盤 | 001 | 完了 | NFR-003, NFR-037 |
| 004 | 認証トリガー実装 | 003 | 完了 | FR-001, FR-015 |
| 005 | 監視・ログ基盤 | 003 | 完了 | NFR-028, NFR-029, NFR-030 |
| 006 | GDPR同意管理API | 002, 003 | 未着手 | FR-024, FR-002-1 |
| 007 | ユーザーAPI | 002, 003 | 未着手 | FR-002 |
| 008 | CI/CDパイプライン | 003 | 未着手 | NFR-026, NFR-027 |
| 009 | セキュリティレビュー | 002, 003, 004 | 未着手 | NFR-013, NFR-012 |
| 010 | Phase 1完了確認 | 001-009 | 未着手 | NFR-027 |

### Phase 2: API・データパイプライン実装（011-030）

| ID | タイトル | 依存チケット | 状態 | 関連FR・NFR |
|----|---------|------------|------|-----------|
| 011 | トレーニングセッション保存API | 002, 004 | 未着手 | FR-008 |
| 012 | セッション取得API | 002, 004 | 未着手 | FR-009 |
| 013 | トレーニング履歴一覧API | 002, 004 | 未着手 | FR-010 |
| 014 | セッション削除API | 002, 004 | 未着手 | FR-011 |
| 015 | BigQuery ストリーミングパイプライン | 001, 002 | 未着手 | NFR-006 |
| 016 | データ匿名化・加工処理 | 015 | 未着手 | NFR-008 |
| 017 | BigQuery テーブル構築 | 001 | 未着手 | NFR-007 |
...
|--------------|------------|---------------|------|------|
| 001: Firebase環境確認 | 001: Firebase接続設定 | 001: Firebase接続設定 | ✅ Common完了 | Firebase基盤完了後にフロントエンド接続設定が可能 |
| 002: Firestore Security Rules | 006: 認証画面 | 006: 認証画面 | 🔄 Common進行中 | Security Rules完了後に認証画面のテストが可能 |
| 003: Cloud Functions基盤 | 006: 認証画面 | 006: 認証画面 | ✅ Common完了 | Functions基盤完了後に認証機能が動作 |
| 004: 認証トリガー実装 | 006: 認証画面 | 006: 認証画面 | ✅ Common完了 | 認証トリガー完了後にユーザー作成・削除が可能 |
| 005: 監視・ログ基盤 | - | - | ✅ Common完了 | バックエンドのみ（フロントエンド依存なし） |
| 006: GDPR同意管理API | 007: 利用規約同意画面 | 007: 利用規約同意画面 | ⏳ Common未着手 | 同意管理API完了後に利用規約画面が実装可能 |
| 007: ユーザーAPI | 009: プロフィール画面 | 009: プロフィール画面 | ⏳ Common未着手 | ユーザーAPI完了後にプロフィール画面が実装可能 |
| 008: CI/CDパイプライン | - | - | ⏳ Common未着手 | バックエンドのみ（フロントエンド依存なし） |
| 009: セキュリティレビュー | - | - | ⏳ Common未着手 | バックエンドのみ（フロントエンド依存なし） |
| 010: Phase 1完了確認 | - | - | ⏳ Common未着手 | バックエンドのみ（フロントエンド依存なし） |
...
|--------------|---------|-----------------|------------------|----------|
| 001-003 | 0-1ヶ月 | 001, 006（認証画面） | 001, 006（認証画面） | ✅ 完了 |
| 004 | 1-2ヶ月 | 006（認証画面） | 006（認証画面） | ✅ 完了 |
| 005 | 1-2ヶ月 | 監視基盤共有 | 監視基盤共有 | ✅ 完了 |
| 006 | 1-2ヶ月 | 007（利用規約画面） | 007（利用規約画面） | ⏳ 未着手 |
| 007 | 1-2ヶ月 | 009（プロフィール画面） | 009（プロフィール画面） | ⏳ 未着手 |
