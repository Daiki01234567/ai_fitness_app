...
- [x] `stripe_cancelSubscription` Callable Functionを実装
- [x] 即時解約と期間終了時解約の切り替えを実装
- [x] Stripe APIでサブスクリプションをキャンセルする処理を実装
- [x] Firestoreのサブスクリプション情報を更新する処理を実装
- [x] 解約確認メールを送信する処理を実装（オプション）
- [x] エラーハンドリングを実装
...
|------|----------|
| 2025-12-10 | 初版作成 |
| 2025-12-11 | チケット完了 - stripe_cancelSubscription実装、即時解約/期間終了時解約対応、メール送信、テスト完了 |
