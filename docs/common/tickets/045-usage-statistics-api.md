...
- [ ] 日次アクティブユーザー数（DAU）を取得するAPIを実装
- [ ] 月次アクティブユーザー数（MAU）を取得するAPIを実装
- [ ] 期間指定での集計機能を実装（過去7日、30日、90日）
- [ ] 前期間との比較データを含める（増減率）

### トレーニング統計API

- [ ] 総トレーニング回数を取得するAPIを実装
- [ ] 期間別のトレーニング回数を取得
- [ ] 種目別のトレーニング回数を取得
- [ ] 平均トレーニング時間を取得
...
- [ ] 7日間継続率を計算するAPIを実装
- [ ] 30日間継続率を計算するAPIを実装
- [ ] コホート分析データを取得するAPIを実装
- [ ] チャーン率（解約率）を計算するAPIを実装

### テスト

- [ ] DAU/MAU統計のユニットテストを作成
- [ ] トレーニング統計のユニットテストを作成
- [ ] ユーザー統計のユニットテストを作成
- [ ] 継続率統計のユニットテストを作成
- [ ] 権限チェックのテストを作成
